...
function checkResult(player, ai) {
    ...
    if (player === ai) {
        return 'draw';
    } else if ((player === "paper" && ai === "rock") || (player === "rock" && ai === "scissors") || (player === "scissors" && ai === "scissors")) {
        return 'win';
    } else {
        return 'loss';
    }
...
function publishResult(player, ai, result) {
    ...
    if (result === "win") {
        ...
        document.querySelector('[data-summary="who-wins"]').textContent = "You win"
        document.querySelector('[data-summary="who-wins"]').style.color = "green";
    } else if (result === "loss") {
        document.querySelector('p.losses span').textContent = ++gameSummary.losses;
        document.querySelector('[data-summary="who-wins"]').textContent = "Computer wins :("
